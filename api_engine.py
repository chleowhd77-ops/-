...
ANALYSIS_VERSION = "V7.12.7-two-analyzer-live-test"
...
def combine_availability_penalties(injury, lineup, goal_dependency, fatigue, rotation, depth=1.0):
    ...
    return min(0.10, max(0.0, (1 - (1-absence) * (1-schedule)) * float(depth or 1)))
